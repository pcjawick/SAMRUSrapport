...
%%%\setcounter{section}{0}
              ...
              \rule{\textwidth}{1pt}\\%horisontal linje
               % \paragraph{Skaffe en oversikt\\} KArin korrektur
                  Dette oversiktsarbeidet skulle munne ut i å beskrive noen arbeidsmodeller eller beskrivelser. Dette skulle tjene som en mal å jobbe videre med. Følgende punkter er hentet fra prosjektbeskrivelsen\cite{ProPlan-1}.
                  \paragraph{Disse tiltakene skulle implementeres i løpet av prosjektet:\\}
                  \begin{enumerate}
                    \item Beskrive en modell for sømløs oppfølging og pasienflyt i rus- og psykiatritjeneste med aktiv bruk av IP Etablere et system for at hver pasient får en plan for arbeid og aktivitet i løpet av oppfølgingen
                    \item Det skal være beskrevet en modell for pasienNlyt og ansvarsplassering
                    \item Definere ansvaret/roller for:
                      \begin{itemize}
                        \item Fastlege
                        \item Andrelinje
                        \item Kommunal psykiatri og rustjenester NAV
                      \end{itemize}
                    \item Det skal være etablert et bekymringsmeldingssystem
                    \item Sikre en helthetlig utredning som også innbefaler somatisk sykdom.
                  \end{enumerate}
    
                  \paragraph{Gjøremål og metodevalg\\}
                    \begin{enumerate}
                      \item Beskrive organisering (ansvar og rollefordeling), helhetlig behandlingsmodell og pasienNlyt i kommunal psykiatri- og rustjenesten, andrelinjetjenesten, fastleger og NAV
                      \item Tiltak for bruk av IP(individuell plan) aktivt ovenfor alle pasienter
                      ...
                      \item Lage et system for systematisk å motta, bearbeide og videreformidle bekymringsmeldinger til rett instans
                      \item Tilpasse veilederen for internkontroll til driften i de respektive kommunale tjenester
                    \end{enumerate}
                  
                  \paragraph{Målgruppene for prosjektet}
                    \begin{enumerate}
                      \item Innbyggere i begge Eiker kommunene som har et misbruk av rusmidler og/eller psykisk sykdom, får en helhetlig koordinert tjeneste 
                      \item Bedre flyt i behandlingskjeden
                      \item Tilbud om tjenester tilrettelagt ut fra pasientens individuelle behov
                      \item Redusert antall innleggelser
                      \item Rutiner for samarbeid på tvers av omsorgsnivå
                      \item Enklere å indentifisere pasientens største behov for hjelp
                      \item Livsløpsperspektiv gjennom IP og koordinerende enhet
                      \item Bedre kommunikasjon gjennom helsetjenestene på hvert nivå
                    \end{enumerate}
              ...
              \begin{itemize}
                ...
                \item \textbf{Marit Kolbræk}, leder psykiatriboliger Nedre Eiker\\
              ...
              \end{thebibliography}
                ...
                \appendix
                  ...
                  \chapter{Prosjektdirektivet}\label{orig_pro_beskr}
                    ...
                    \includepdf[pages={1,2,3,4}]{./apps/Prosjektplansamrus.pdf}
